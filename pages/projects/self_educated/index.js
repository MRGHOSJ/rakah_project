      ...
      <div className="mt-24 max-w-screen-xl px-6 sm:px-8 lg:px-40 py-3 sm:py-4">
        ...
        <div className="mt-5 mx-auto grid xl:grid-cols-3 md:grid-cols-2 gap-4 py-3 sm:py-4">
          <ProjectCard
            ...
            title="Game"
            sub="Here you will find every tips , tricks and the full guidelines on how to create a game out of SDL and C"
            level="1 st"
          ...
          <ProjectCard
            ...
            title="Desktop App"
            sub="Here you will find every tips , tricks and the full guidelines on how to create a desktop app"
            level="2 nd"
          ...
          <ProjectCard
            title="Symphony"
            sub="Here you will find every tips , tricks and the full guidelines on how to create a symphony project"
            level="3 rd"
            programingLanguage={["Symphony"]}
            coming_soon={true}
            href="self_educated/symphony"
          />
        </div>
      </div>
